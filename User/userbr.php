...
<?php 
    ...
    if (isset($_GET['req'])) {
        $book_id = $_GET['req'];
        mysqli_query($db, "UPDATE books SET status = 'To_be_paid' WHERE book_id='$book_id'");
        
        
        header('location: userbr.php');
    }
?>
	...
	<body>
        ...
        <?php
            ...
            while ($row = mysqli_fetch_array($results)) {
                ...
                if ($row['status'] == 'Borrowed' && $row['username'] == $user) {
                ...
                <a class='confirmation btn btn-danger link-light text-decoration-none' role='button' href='userbr.php?req=".$row['book_id']."'>Return</a>
