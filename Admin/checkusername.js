 ...
 */
 ...
 // Send the request:
	...
	document.getElementById('username').innerHTML = 'The availability of this username will be confirmed upon form submission.';
 }
 ...
 // Assign the returned value to a document element:
	document.getElementById('username').innerHTML = ajax.responseText;
